...
public partial class SettingsViewModel : ObservableObject
{
    ...
    {
        long bytes = DashboardCacheService.Instance.ClearCache();
        string sizeText = bytes >= 1024 * 1024
            ? $"{bytes / 1024d / 1024d:F2} MB"
            : $"{bytes / 1024d:F1} KB";
        var dialog = new YCPLauncher.Views.MessageDialog($"缓存已清空 ({sizeText})", "清理完毕");
    ...
    partial void OnIsDarkModeChanged(bool value)
    {
        ...
        if (Application.Current.MainWindow != null)
        {
            ...
            if (Application.Current.MainWindow is MainWindow mainWindow)
                mainWindow.SetAmbientVisualsEnabled(value);
        }
    }
    ...
    partial void OnReduceAnimationsChanged(bool value)
    {
        ...
        ConfigService.SaveConfig();
        if (Application.Current.MainWindow is MainWindow mainWindow)
            mainWindow.SetAmbientVisualsEnabled(IsDarkMode);
    }
