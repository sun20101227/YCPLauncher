<div align="center">
  ...
  ![Version](https://img.shields.io/badge/version-0.0.10_Beta-blue?style=flat-square)
...
**YCP 电竞启动器**是 YACHIYO CUP 2026 CS2 赛事的官方客户端程序，基于 WPF + .NET 8 开发，提供选手登录、服务器列表、赛程信息、直播嵌入等一站式功能。
